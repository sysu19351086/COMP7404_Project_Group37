...
url_train_data = "datasets/feature_number/arcene/ARCENE/arcene_train.data"
url_train_labels = "datasets/feature_number/arcene/ARCENE/arcene_train.labels"
url_valid_data = "datasets/feature_number/arcene/ARCENE/arcene_valid.data"
url_valid_labels = "datasets/feature_number/arcene/arcene_valid.labels"
...
output_dir = "outputs/feature_number/arcene"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

# Save Data to CSV File
csv_filename = os.path.join(output_dir, "arcene.csv")
...
# Save Chart to File
image_filename = os.path.join(output_dir, "arcene.png")
