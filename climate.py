...
url = "datasets/sample_size/climate/pop_failures.dat"
...
output_dir = "outputs/sample_size/climate"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

# Save Data to CSV File
csv_filename = os.path.join(output_dir, "climate.csv")
...
# Save Chart to File
image_filename = os.path.join(output_dir, "climate.png")
