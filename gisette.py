...
url_train_data = "datasets/feature_number/gisette/GISETTE/gisette_train.data"
url_train_labels = "datasets/feature_number/gisette/GISETTE/gisette_train.labels"
url_valid_data = "datasets/feature_number/gisette/GISETTE/gisette_valid.data"
url_valid_labels = "datasets/feature_number/gisette/gisette_valid.labels"
...
output_dir = "outputs/feature_number/gisette"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

# Save Data to CSV File
csv_filename = os.path.join(output_dir, "gisette.csv")
...
# Save Chart to File
image_filename = os.path.join(output_dir, "gisette.png")
