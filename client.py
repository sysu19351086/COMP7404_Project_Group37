...
path = "datasets/sample_size/client/default of credit card clients.csv"
data = pd.read_csv(path, header=1, index_col=0, skiprows=2)
data = data.iloc[:4000]
...
output_dir = "outputs/sample_size/client"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

# Save Data to CSV File
csv_filename = os.path.join(output_dir, "client.csv")
...
# Save Chart to File
image_filename = os.path.join(output_dir, "client.png")
