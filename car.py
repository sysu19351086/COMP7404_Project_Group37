...
url = "datasets/sample_size/car/car.data"
...
output_dir = "outputs/sample_size/car"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

# Save Data to CSV File
csv_filename = os.path.join(output_dir, "car.csv")
...
# Save Chart to File
image_filename = os.path.join(output_dir, "car.png")
