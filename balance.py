...
url = "datasets/sample_size/balance/balance-scale.data"
columns = ['class', 'left_weight', 'left_distance', 'right_weight', 'right_distance']
...
avg_iter_time_gsknn = model.avg_iteration_time
...
output_dir = "outputs/sample_size/balance"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

# Save Data to CSV File
csv_filename = os.path.join(output_dir, "balance.csv")
...
# Save Chart to File
image_filename = os.path.join(output_dir, "balance.png")
